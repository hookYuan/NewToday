package lovcreate.com.newtoday.witget;
...
import lovcreate.com.newtoday.spannable.CircleMovementMethod;
...
public class ExpandTextView extends LinearLayout {
    ...
    public void setText(CharSequence content){
       ...
       contentText.setMovementMethod(new CircleMovementMethod(getResources().getColor(R.color.textGrayNormal)));
    }
