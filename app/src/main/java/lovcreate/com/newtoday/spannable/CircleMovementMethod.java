...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    private final static int DEFAULT_COLOR_ID = R.color.textGrayNormal;
    private final static int DEFAULT_CLICKABLEA_COLOR_ID = R.color.textBlackNormal;
    /**整个textView的背景色*/
    ...
    public CircleMovementMethod(){
        this.textViewBgColor = BaseApplication.getApplication().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = BaseApplication.getApplication().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
...
//            widget.setBackgroundResource(R.color.textGrayNormal);
